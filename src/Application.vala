...
public class Rpy.Application : Gtk.Application
{
	...
	public override void startup ()
	{
		...
		var parameter = GLib.Value (typeof (Rpy.MainViewModel));
		parameter.set_object (new Rpy.MainViewModel ());
	...
	private void ensure_type_registration ()
	{
		...
		typeof (Rpy.NavigationSidebar).ensure ();
		typeof (Rpy.NavigationSidebarRow).ensure ();
	}
